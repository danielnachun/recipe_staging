...
sed -i 's?/home/bin/python2?/usr/bin/env python?' ${PREFIX}/libexec/${PKG_NAME}/phaser/phaser.py
# sed -i '1i #!/usr/bin/env python' ${PREFIX}/libexec/${PKG_NAME}/phaser_annotate/phaser_annotate.py
sed -i '1i #!/usr/bin/env python' ${PREFIX}/libexec/${PKG_NAME}/phaser_gene_ae/phaser_gene_ae.py
sed -i '1i #!/usr/bin/env python' ${PREFIX}/libexec/${PKG_NAME}/phaser_pop/phaser_cis_var.py
sed -i '1i #!/usr/bin/env python' ${PREFIX}/libexec/${PKG_NAME}/phaser_pop/phaser_expr_matrix.py
