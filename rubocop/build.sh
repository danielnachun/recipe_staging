...
mkdir -p ${PREFIX}/bin
sed -i "s?\$bindir?${PREFIX}/bin?g" ${PREFIX}/libexec/${PKG_NAME}/bin/rubocop
cat << EOF > ${PREFIX}/bin/rubocop
#!/bin/sh
GEM_HOME=${PREFIX}/share/rubygems exec ${PREFIX}/libexec/${PKG_NAME}/bin/rubocop "\$@"
EOF
