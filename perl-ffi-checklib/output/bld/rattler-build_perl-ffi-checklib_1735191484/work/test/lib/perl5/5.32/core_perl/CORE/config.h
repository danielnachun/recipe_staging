 ...
 *	some shell.
 */
#define STARTPERL "#!/Users/danielnachun/ghq/github.com/danielnachun/recipe_staging/perl-ffi-checklib/output/bld/rattler-build_perl-ffi-checklib_1735191484/work/test/bin/perl"		/**/
