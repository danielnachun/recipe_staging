...
perl Makefile.PL INSTALLDIRS=site LDFLAGS="$LDFLAGS --sysroot=${CONDA_BUILD_SYSROOT}" LDDLFLAGS="$LDFLAGS --sysroot=${CONDA_BUILD_SYSROOT}" CCFLAGS="${CFLAGS}" LIBS="-L${PREFIX}/lib -lxml2" INC="-I$PREFIX/include/libxml2 -I$PREFIX/include -I${CONDA_BUILD_SYSROOT}/usr/include" CC=${CC} LD=${CC}
