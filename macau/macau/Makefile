...
SOURCES = main.cpp macau.cpp io.cpp gzstream.cpp param.cpp bmm.cpp pmm.cpp nb.cpp

HDR = param.h gzstream.h io.h macau.h bmm.h pmm.h nb.h
...
LIBS_LNX_S_LAPACK = /usr/lib/lapack/liblapack.a -lgfortran  /usr/lib/atlas-base/libatlas.a /usr/lib/libblas/libblas.a -Wl,--allow-multiple-definition -fopenmp -lquadmath
