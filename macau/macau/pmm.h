...
public:
	...
	void EigenProc (const gsl_matrix *K, const gsl_matrix *B, const gsl_matrix *W, const gsl_vector *x, const gsl_vector *D1i, const gsl_vector *D2i, gsl_matrix *U1_mat, gsl_matrix *U2_mat, gsl_matrix *Uh_mat, gsl_matrix *Eval_h, gsl_matrix *UtW, gsl_matrix *Utx);
	...
	void SampleBAU (const class HYPPAR &cHyp, const gsl_matrix *Eval_h, const gsl_matrix *Pab, const gsl_matrix *Uh_mat, const gsl_matrix *UtW, const gsl_matrix *Utx, const gsl_matrix *Utz, double &beta, vector<double> &alpha, gsl_vector *u);
