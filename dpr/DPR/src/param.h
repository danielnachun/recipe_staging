...
// WJA Added
	...
	// VB related parameters zeng ping
	 //size_t ldrnbi,ldrnmc;
	size_t n_k,mnk,mixture_no,tp;
	double pcutoff,DIC1,pD1,BIC1,DIC2,pD2,BIC2,LBO,sp;
	//
	...
	void ReadGenotypes (MatrixXd UtX, gsl_matrix *K, const bool calc_K);
	void CheckCvt ();
	...
	void CopyLDblock (gsl_matrix *LDblock0);//zp
	void CalcKin (gsl_matrix *matrix_kin);
	void CalcS (gsl_matrix *S, gsl_matrix *Svar, gsl_matrix *V, gsl_vector *ns);
