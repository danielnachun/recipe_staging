...
public:
	...
	//ZP
	void Call_lm_Pvalue(vector<double> *lm_pvalue); 
	void Call_lm_Beta(vector<double> *lm_beta); 
	void Call_lm_Se(vector<double> *lm_se); 
	void Call_lm_Rs(vector<string> *lm_rs); 
	void Call_lm_Position(vector<int> *lm_Position);
	void Call_lm_Chr(vector<int> *lm_Chr);
	void Call_lm_Chr_Position(vector<int> *lm_Chr, vector<int> *lm_Position);
	//ZP
